            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button
                    type="button"
                    class="self-center p-1 hover:bg-gray-100 shrink-0 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-100 duration-100"
                    @click="open = false"
                  >
